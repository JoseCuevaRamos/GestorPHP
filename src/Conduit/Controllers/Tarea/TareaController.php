...
class TareaController
{
    ...
    public function store(Request $req, Response $res): Response
    {
        ...
        HistorialMovimiento::create([
            'id_tarea' => $t->id_tarea,
            'id_columna_anterior' => null,              // NULL porque se acaba de crear
            'id_columna_nueva' => $t->id_columna,       // Columna inicial
            'id_usuario' => $userId,                    // Quién la creó
    ...
    public function move(Request $req, Response $res, array $args): Response
    {
        ...
        HistorialMovimiento::create([
            'id_tarea' => $idTarea,
            'id_columna_anterior' => $idColumnaAnterior,  // ⭐ De dónde VINO
            'id_columna_nueva' => $idColumnaDestino,      // ⭐ A dónde FUE
            'id_usuario' => $userId,                      // ⭐ Quién lo movió
            'timestamp' => Carbon::now(),
        ]);
    ...
    public function setDue(Request $req, Response $res, array $args): Response  // ⭐ CORREGIDO: Era "RFhistorialequest"
    {
    ...
    public function bulkMove(Request $req, Response $res): Response
    {
        ...
        foreach ($data['ids'] as $idTarea) {
            HistorialMovimiento::create([
                'id_tarea' => $idTarea,
                'id_columna_anterior' => $tareasConColumnaAnterior[$idTarea] ?? null,  // ⭐ De dónde VINO
                'id_columna_nueva' => $idColumnaDestino,                                // ⭐ A dónde FUE
                'id_usuario' => $userId,                                                // ⭐ Quién lo movió
                'timestamp' => Carbon::now(),
            ]);
